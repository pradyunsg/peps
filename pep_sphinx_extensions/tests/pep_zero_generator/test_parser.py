...
def test_pep_repr():
    pep8 = parser.PEP(Path("peps/pep-0008.rst"))
...
def test_pep_less_than():
    pep8 = parser.PEP(Path("peps/pep-0008.rst"))
    pep3333 = parser.PEP(Path("peps/pep-3333.rst"))

    assert pep8 < pep3333


def test_pep_equal():
    pep_a = parser.PEP(Path("peps/pep-0008.rst"))
    pep_b = parser.PEP(Path("peps/pep-0008.rst"))
...
def test_parse_authors(test_input, expected):
    # Arrange
    dummy_object = parser.PEP(Path("peps/pep-0160.rst"))
...
def test_parse_authors_invalid():
    ...
    pep = parser.PEP(Path("peps/pep-0008.rst"))
