...
No three Packaging Council members should be employed by or significantly affiliated with the same entity.
...
An earlier non-public draft of this PEP utilised an approval voting process, which aligned with what :pep:`13` stated at the time of writing. Since the Python core team has consensus to move away from that and utilise BLOC-STAR, this PEP was updated to align with that for the same reasons as the core teams' move to BLOC STAR: it better captures voter intention in the results.
